...
use Ffcms\Templex\Helper\Html\Bootstrap5\Nav;
use Ffcms\Templex\Helper\Html\Bootstrap5\Navbar;
use League\Plates\Engine;
use League\Plates\Extension\ExtensionInterface;

/**
 * Class Bootstrap5. Bootstrap 5 html builder instance
 * @package Ffcms\Templex\Helper\Html
 */
class Bootstrap5 implements ExtensionInterface
{
    const CSS_TYPES = [
     ...
     * @return Bootstrap5
     */
    public static function factory(): Bootstrap5
    {
        if (!self::$instance) {
    ...
    public function button(string $type, string $text, ?array $properties = null): ?string
    {
        ...
        if ($type === 'button') {
            ...
            $properties['value'] = htmlspecialchars($text);
    ...
    {
        return Bootstrap5\Pagination::factory($url, $properties, $liProperties, $aProperties);
    }
     ...
     * @return Bootstrap5\ButtonGroup
     */
    public function btngroup(?array $properties = null, int $dropdownLimit = 3)
    {
        return Bootstrap5\ButtonGroup::factory($properties, $dropdownLimit);
    }
}
